...
object SurveyRequestFixture {
    ...
    fun createRequest(selectedCategoryList: List<Long> = listOf(1L, 3L)) =
        SurveyCreateRequest(selectedCategoryList = selectedCategoryList)
    ...
    fun createResponse(message: String = "설문 제출이 완료되었습니다") =
        SurveyCreateResponse(message = message)
}
