...
class MeetingController(
    ...
    @GetMapping
    suspend fun getMeeting(@UserId userId: Long): DpmApiResponse<List<MeetingsResponse>> {
    ...
    @PostMapping
    suspend fun create(@UserId userId: Long, @RequestBody @Valid request: CreateMeetingRequest): DpmApiResponse<CreateMeetingResponse> {
    ...
    @PostMapping("/join")
    suspend fun join(@UserId userId: Long, @RequestBody @Valid request: JoinMeetingRequest): DpmApiResponse<Unit> {
