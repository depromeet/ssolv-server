...
class CreateSurveyService(
    ...
    suspend fun invoke(meetingId: Long, userId: Long, request: SurveyCreateRequest): SurveyCreateResponse = withTracingContext {
        transactionTemplate.execute {
            ...
            if (currentSurveyCount >= meetingEntity.attendeeCount) {
                val requestId = org.slf4j.MDC.get(
                    org.depromeet.team3.common.filter.MdcLoggingFilter.REQUEST_ID,
